class SecretsController < ApplicationController
  ...
  # GET /secrets/1 - no file extension, it will ask for .html
  # GET /secrets/1.json - this .json.jbuilder
    # In JavaScript, we should now be able to call secret.fetch();
  def show
  end
  ...
  # POST /secrets - comes from an HTML form
  # POST /secrets.json - comes from AJAX
    # In JS, var s = new app.Secret(); s.save();
  def create
